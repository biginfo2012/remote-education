...
<!--      <div style="color: white">2020 09 23</div>-->
        ...
        <b-col cols="9">
          <div class="form-side line-form">
            <b-form @submit.prevent="formSubmit">
              <b-row>
                <b-col cols="4 pr-0" >
                  <b-button variant="primary default" class="btn-block text-center px-1" size="lg"
                            :disabled="processing">{{
                      $t('login.mobile')}}
                  </b-button>
                </b-col>
...
<!--                                                                       class="icofont-ui-user"/> </span>-->
                ...
                <b-col cols="4">
                  <b-button variant="primary default" class="btn-block text-center" size="lg"
                            :disabled="processing">{{
                      $t('login.send')}}
                  </b-button>
                </b-col>
  ...
  export default {
    ...
    methods: {
      ...
      formSubmit() {
        ...
        if(this.account == 'test@admin.com'){
          this.$router.push('/admin/dashboard');
        }
        if(this.account == 'test@admin-org.com'){
          this.$router.push('/org-admin/base-info/organization-presentation');
        }
