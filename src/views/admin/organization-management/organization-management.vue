...
<template>
  <div>
    ...
    <b-card v-show="!isLoading" class="main-without-tab" style="margin-top: 20px;">
            ...
            <b-row class="pt-2">
              <b-col class="d-flex">
                <div class="flex-grow-1">
                  <b-row>
                    <b-col>
                      <b-form-group :label="$t('admin.nickname')">
                    ...
                    <b-col>
                      <b-form-group :label="$t('admin.admin-name')">
                        <b-form-input v-model="filter.orgName"/>
                      </b-form-group>
                    </b-col>

                    <b-col>
                      <b-form-group :label="$t('admin.office-phone')">
                        <b-form-input v-model="filter.orgName"/>
                      </b-form-group>
                    </b-col>

                    <b-col>
                      <b-form-group :label="$t('admin.type')">
                        <b-form-select :options="statusSelectOptions" v-model="filter.status" plain/>
                      </b-form-group>
                    </b-col>

                    <b-col>
                      <b-form-group :label="$t('admin.company-code')">
                        <b-form-input v-model="filter.orgName"/>
                      </b-form-group>
                    </b-col>
              ...
              <b-col class="d-flex">
                ...
                <div class="align-self-center">
                  ...
                  <b-button size="sm" class="ml-2" variant="success default" @click="showCreatePage()">
                    <i class="icofont-plus"/>&nbsp;{{$t('btn.add') }}
                  </b-button>
                </div>
              </b-col>
            </b-row>
        ...
        <b-row v-if="pageStatus==='create'" class="h-100 form-section">
          <b-col cols="7">
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.nickname')}}&nbsp;<span
              ...
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.name')}}&nbsp;<span
                    class="text-danger">*</span></template>
                  <b-form-input type="text"
            ...
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.type')}}&nbsp;<span
                    class="text-danger">*</span></template>
              ...
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.company-code')}}&nbsp;<span
                    class="text-danger">*</span></template>
            ...
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('org.address')}}</template>
                  <b-form-input type="text"
              ...
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.office-phone')}}</template>
                  <b-form-input type="text"
            ...
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.admin-name')}}</template>
                  <b-form-input
              ...
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.admin-mobile')}}</template>
                  <b-form-input
                    v-model="createPage.note"
                  />
                </b-form-group>
            ...
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">营业执照 照片上传</template>
                  <b-form-input
                    v-model="createPage.note"
                  />
                </b-form-group>
          ...
          <b-col cols="5">
            <b-row class="align-middle my-auto">
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.code')}}&nbsp;<span
                    class="text-danger">*</span></template>
                  <b-form-input type="text"
                                v-model="createPage.orgNumber"
                                :state="!$v.createPage.orgNumber.$dirty ? null : !$v.createPage.orgNumber.$invalid"/>
    ...
    return {
      ...
      vuetableItems: { // main table options
        ...
        fields: [
          ...
          {
            name: 'status',
            title: this.$t('admin.company-code'),
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: '7%',
            callback: (value) => {
          ...
          {
            name: 'parent',
            title: this.$t('admin.office-phone'),
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: '8%',
            callback: (value) => {
          ...
          {
            name: 'mobile',
            title: this.$t('admin.admin-phone'),
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: '15%'
          },
          {
            name: 'noteLabel',
            title: this.$t('admin.create-date'),
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: '16%',
            callback: (value) => {
