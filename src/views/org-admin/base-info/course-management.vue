        ...
        <b-row v-if="pageStatus==='create'" class="h-100 form-section">
          <b-col cols="12">
            <b-row>
              ...
              <b-col cols="12">
                <b-form-group>
                  <template slot="label">{{$t('org-admin.content')}}&nbsp;<span
                    class="text-danger">*</span></template>
                  <b-form-input type="text"
            ...
            <b-row>
              <b-col cols="12">
                <b-form-group>
                  <template slot="label">{{$t('org-admin.introduction')}}
                  </template>
      ...
      vuetableItems: { // main table options
        ...
        fields: [
          ...
          },
          {
            ...
            title: this.$t('org-admin.content'),
            sortField: 'orgNumber',
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: ''
          ...
          {
            name: 'orgNameLabel',
            title: this.$t('org-admin.introduction'),
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: '',
            callback: (value) => {
