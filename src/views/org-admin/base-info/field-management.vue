        ...
        <b-row v-if="pageStatus==='create'" class="h-100 form-section">
          <b-col cols="12">
            <b-row>
              <b-col cols="7">
                <b-form-group>
                  <template slot="label">{{$t('admin.field-name')}}&nbsp;<span
              ...
              <b-col cols="7">
                <b-form-group>
                  <template slot="label">{{$t('org-admin.pos')}}&nbsp;<span
                    class="text-danger">*</span></template>
                  <b-form-input type="text"
            ...
            <b-row>
              <b-col cols="7">
                <b-form-group>
                  <template slot="label">{{$t('org-admin.limit')}}
                  </template>
