...
.form-control {
  border-radius: 0.3rem;
  padding: 0.5rem 0.4rem 0.55rem 0.5rem;
  max-width: 80%;
}
</style>
              ...
              <b-col class="d-flex">
                <div class="flex-grow-1">
                  <b-row>
                    ...
                    <b-col>
                      <b-form-group :label="$t('admin.tea-name')">
                        <b-form-input v-model="filter.orgName"/>
                      </b-form-group>
                    </b-col>

                    <b-col>
                      <b-form-group :label="$t('admin.student-name')">
                        <b-form-input v-model="filter.orgName"/>
                      </b-form-group>
                    </b-col>

                    <b-col>
                      <b-form-group :label="$t('admin.course-name')">
                        <b-form-input v-model="filter.orgName"/>
                      </b-form-group>
                    </b-col>

                    <b-col>
                      <b-form-group :label="$t('admin.field-name')">
                        <b-form-input v-model="filter.status"/>
                      </b-form-group>
                    </b-col>
        ...
        <b-row v-if="pageStatus==='create'" class="h-100 form-section">
          <b-col cols="12">
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.class-name')}}&nbsp;<span
              ...
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('org-admin.course')}}&nbsp;<span
                    class="text-danger">*</span></template>
            ...
            <b-row>
              <b-col cols="12">
                <b-form-group>
                  <template slot="label">{{$t('org-admin.teacher')}}&nbsp;<span
                    class="text-danger">*</span></template>
              ...
              <b-col cols="12">
                <b-form-group>
                  <template slot="label">{{$t('admin.student')}}&nbsp;<span
                    class="text-danger">*</span></template>
                  <v-select v-model="fileSelection" :options="fileSelectionOptions"
                            :state="!$v.fileSelection.$invalid" :searchable="false"
                            class="v-select-custom-style" :dir="direction" multiple/>
            ...
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('org-admin.field')}}</template>
                  <b-form-select :options="parentOrganizationNameSelectOptions"
                                 v-model="createPage.orgName"
                                 :state="!$v.createPage.orgName.$dirty ? null : !$v.createPage.orgName.$invalid"/>
                </b-form-group>
              ...
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.pc-per-lesson')}}</template>
                  <b-form-select :options="parentOrganizationNameSelectOptions"
                                 v-model="createPage.orgName"
                                 :state="!$v.createPage.orgName.$dirty ? null : !$v.createPage.orgName.$invalid"/>
                </b-form-group>
    ...
    return {
      ...
      vuetableItems: { // main table options
        ...
        fields: [
          ...
          {
            name: 'parent',
            title: this.$t('org-admin.schedule'),
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: '8%',
            callback: (value) => {
          ...
          {
            name: 'leader',
            title: this.$t('admin.pc-per-lesson'),
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: '8%'
          },
