      ...
      taskVuetableItems: {
        ...
        fields: [
          ...
          },
          {
            ...
            title: this.$t('org-admin.class'),
            titleClass: 'text-center',
            dataClass: 'text-center'
          },
          {
            name: '__slot:mode',
            title: this.$t('org-admin.teacher'),
            titleClass: 'text-center',
            dataClass: 'text-center'
          },
          {
            name: 'taskStatus',
            title: this.$t('org-admin.student-cnt'),
            titleClass: 'text-center',
            dataClass: 'text-center',
            callback: (value) => {
              const dictionary = {
          ...
          },
          {
            ...
            title: this.$t('org-admin.sign-cnt'),
            titleClass: 'text-center',
            dataClass: 'text-center'
          },
          {
            name: 'scanDeviceName',
            title: this.$t('org-admin.absence-cnt'),
            titleClass: 'text-center',
            dataClass: 'text-center',
          },
          {
            name: 'scanPointsManName',
            title: this.$t('org-admin.sign-date'),
            titleClass: 'text-center',
            dataClass: 'text-center',
          },
        ],
