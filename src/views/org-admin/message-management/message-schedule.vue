        ...
        <b-row v-if="pageStatus==='create'" class="h-100 form-section">
          <b-col cols="12">
            <b-row>
              ...
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.gen')}}&nbsp;<span
                    class="text-danger">*</span></template>
            ...
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.bir')}}&nbsp;<span
                    class="text-danger">*</span></template>
                  <b-form-select :options="parentOrganizationNameSelectOptions"
                                 :state="!$v.createPage.parentOrgId.$dirty ? null : !$v.createPage.parentOrgId.$invalid"
                                 v-model="createPage.parentOrgId" plain/>
              ...
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('login.mobile')}}&nbsp;<span
                    class="text-danger">*</span></template>
            ...
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.school')}}</template>
                  <b-form-input type="text"
              ...
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.major')}}</template>
                  <b-form-input type="text"
            ...
            <b-row>
              <b-col cols="6">
                <b-form-group>
                  <template slot="label">{{$t('admin.remark')}}</template>
    ...
    return {
      ...
      vuetableItems: { // main table options
        ...
        fields: [
          ...
          {
            name: 'orgNameLabel',
            title: this.$t('org-admin.receiver-name'),
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: '',
            callback: (value) => {
          ...
          {
            name: '__slot:orgNumberLabel',
            title: this.$t('org-admin.class-registration'),
            sortField: 'orgNumber',
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: ''
          ...
          {
            name: '__slot:orgNumberLabel',
            title: this.$t('org-admin.before-lesson'),
            sortField: 'orgNumber',
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: ''
          ...
          {
            name: '__slot:orgNumberLabel',
            title: this.$t('org-admin.while-sign'),
            sortField: 'orgNumber',
            titleClass: 'text-center',
            dataClass: 'text-center',
            width: ''
